    ...
    public function run()
    {
        DB::table('email_templates')->insert([
            ...
            [
                ...
                'subject' => 'Your ticket has been reopened successfully',
            ...
            [
                ...
                'body' => '<p>Dear {{ticket_username}},</p><p><br></p><p>We would like to acknowledge that we have received your request and a guest ticket has been created.</p><p>A support representative will be reviewing your request and will send you a personal response 1-2 bussiness days.</p><p><br></p><p>To view the status of the ticket or add comments, please visit</p><p><a href="{{ticket_customer_url}}" target="_blank">{{ticket_customer_url}}</a></p><p>Note:- Without logging into the above link, you cannot access your ticket.</p><p><br></p><p>We appreciate your patience.</p><p><br></p><p>Sincerely,</p><p>Support Team</p>',
                'created_at' => now(),
                'updated_at' => now()
            ],
            ...
            // code added by vikas  on 22nd sept23---------
            [
                'code' => 'customer_register_request_mail',
                'title' => 'Customers receive e-mail, when they get register request with the application.',
                'subject' => 'Thanks you for registering. Admin will verify you.',
                'body' => '<p class="root-block-node" data-paragraphid="16" data-from-init="true" data-changed="false">Dear {{username}},</p><p>
                </p><p class="root-block-node" data-paragraphid="23" data-from-init="true" data-changed="false"><span class="red-underline" data-startindex="0" data-endindex="2" data-paragraphid="23">&nbsp; &nbsp;</span><br>Thank you for registering as our customer. Be a part of our family. Before activating your account. <b>Admin will verify your account.</b><br><br>Once Admin verify Your account you will get an account activation Email from admin end.</p><p class="root-block-node" data-paragraphid="19" data-from-init="true" data-changed="false">Sincerely,</p><p class="root-block-node" data-paragraphid="20" data-from-init="true" data-changed="false">Support Team</p>',
                'created_at' => now(),
                'updated_at' => now()
            ],

            [
                'code' => 'customer_register_account_activation',
                'title' => 'Customers receive e-mail, when they get registered account activated.',
                'subject' => 'Your Account is activated.',
                'body' => '<p class="root-block-node" data-paragraphid="16" data-from-init="true" data-changed="false">Dear {{username}},</p><p>
                </p><p class="root-block-node" data-paragraphid="23" data-from-init="true" data-changed="false"><span class="red-underline" data-startindex="0" data-endindex="2" data-paragraphid="23">&nbsp; &nbsp;</span><br>Thank you for registering with us, as our customer. Your Account is now <b> officially approved!</b><br><br>Now you can login and proceed.</p><p class="root-block-node" data-paragraphid="19" data-from-init="true" data-changed="false">Sincerely,</p><p class="root-block-node" data-paragraphid="20" data-from-init="true" data-changed="false">Support Team</p>',
                'created_at' => now(),
                'updated_at' => now()
            ],
            // end code by vikas on 22nd sept 23
