...
class Permissiongroupupdate extends Seeder
{
    ...
    public function updatePermissions()
    {
        ...
        $per = [
            ...
            ['id' => 141, 'name' => 'Holidays Access'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Holidays'],
            ['id' => 142, 'name' => 'Holidays Create'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Holidays'],
            ['id' => 143, 'name' => 'Holidays Edit'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Holidays'],
            ['id' => 144, 'name' => 'Holidays Delete'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Holidays'],
            ['id' => 145, 'name' => 'Holidays Import Access'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Holidays'],
        ];
