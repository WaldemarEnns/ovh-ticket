                ...
                if($responsetime->auto_replystatus != null){
                    if($responsetime->auto_replystatus->timezone(setting('default_timezone')) < now()->timezone(setting('default_timezone'))){
                        ...
                        try{
                            ...
                            if($responsetime->tickettype == 'emalitoticket'){
                                $replySubject = 'Re: ' . $responsetime->subject;
                                ...
                                Mail::send([], [], function ($message) use ($responsetime, $replySubject, $body) {
                                    $message->to($responsetime->cust->email)
                                    ...
                                    $headers->addTextHeader('In-Reply-To', '<' . $responsetime->MessageID . '>');
                                    $headers->addTextHeader('References', '<' . $responsetime->MessageID . '>');
                                });
                            }else{
