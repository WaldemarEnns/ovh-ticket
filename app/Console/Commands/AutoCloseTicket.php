                ...
                if($autoclose->auto_close_ticket != null){
                    if($autoclose->auto_close_ticket->timezone(setting('default_timezone')) < now()->timezone(setting('default_timezone')))
                    {
                        ...
                        try{
                            ...
                            if($autoclose->tickettype == 'emalitoticket'){
                                $replySubject = 'Re: ' . $autoclose->subject;
                                ...
                                Mail::send([], [], function ($message) use ($autoclose, $replySubject, $body) {
                                    $message->to($autoclose->cust->email)
                                    ...
                                    $headers->addTextHeader('In-Reply-To', '<' . $autoclose->MessageID . '>');
                                    $headers->addTextHeader('References', '<' . $autoclose->MessageID . '>');
                                });
                            }else{
