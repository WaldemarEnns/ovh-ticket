...
class RegisterController extends Controller
{
        ...
        if(Customer::where('email', '=', $request->email)->exists() ){
            ...
            if($guest->password == null && $guest->provider_id == null && $guest->userType == 'Guest'){
                ...
                try{
                    ...
                    Mail::to($guest->email)
                    ->send( new mailmailablesend( 'customer_register_request_mail', $verifyData ) );


                }catch(\Exception $e){


                    return redirect()->route('auth.login')->with('success', lang('Please Check your Email. You have requested successfull to register. Please login with register email id.', 'alerts'));
                }
                return Response::json(['success' => lang('Please Check your Email. You have requested successfull to register. Please login with register email id.', 'alerts')]);
                ...
                try{
                    ...
                    return redirect()->route('auth.login')->with('success', lang('Please Check your Email. You have requested successfull to register.', 'alerts'));
                }
                return Response::json(['success' => lang('Please Check your Email. You have requested successfull to register.', 'alerts')]);
                // return redirect()->route('auth.login')->with('success', lang('Please Check your Email. You have requested successfull to register.', 'alerts'));
            }
        }
        else{
    ...
    public function registers(Request $request)
    {
        if(setting('REGISTER_DISABLE') == 'off'){
            return Response::json(['success' => lang('Technical Issue', 'alerts')]);
        }
