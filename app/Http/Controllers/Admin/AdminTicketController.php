    ...
    private function emailpassgueststore($request)
    {
        ...
        if($userexits == 1){
            ...
            $guest = Customer::create([
                ...
                'firstname' => '',
                'lastname' => '',
                'username' => current(explode('@', $request->email)),//'GUEST',
                'email' => $request->email,
                'userType' => ucfirst(current(explode('@', $request->email))),//'Guest',
                'password' => null,
                'country' => '',
                'timezone' => 'UTC',
                'status' => '1',
        ...
        $output .= '
            <p class="mb-0 fs-17 font-weight-semibold text-dark">'.$ticket->users->name.'<span class="fs-11 mx-1 text-muted">(Created)</span></p>
        </div>
        <div class="ms-auto">
        <span class="float-end badge badge-primary-light">
