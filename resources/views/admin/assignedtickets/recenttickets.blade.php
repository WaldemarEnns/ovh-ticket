										...
										<div class="spruko-delete">
											...
											<div class="table-responsive ">
												<table class="table table-bordered border-bottom text-nowrap" id="overduetickets">
													...
													<tbody id="refresh">
													@if(1 || !empty(Auth::user()->getRoleNames()[0]) && (Auth::user()->getRoleNames()[0] == 'Modérateur' || Auth::user()->getRoleNames()[0] == 'MODERATOR' || Auth::user()->getRoleNames()[0] == 'moderator' || Auth::user()->getRoleNames()[0] == 'superadmin'))
														@php $i = 1; @endphp
														@foreach ($gtickets as $tickets)
														@if(1 || $tickets->myassignuser_id == null && $tickets->selfassignuser_id == null)
