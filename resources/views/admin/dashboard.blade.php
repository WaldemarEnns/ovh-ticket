@extends('layouts.adminmaster')
		...
		@endsection
							...
							<!-- @if(!empty(Auth::user()->getRoleNames()[0]) && (Auth::user()->getRoleNames()[0] == 'Modérateur' || Auth::user()->getRoleNames()[0] == 'MODERATOR' || Auth::user()->getRoleNames()[0] == 'moderator' || Auth::user()->getRoleNames()[0] == 'superadmin')) -->
							<div class="row row-sm">
								<div class="col-lg-12">
									<div class="card">
										<div class="card-header border-0">
											
											<h4 class="card-title">{{lang('Recent Tickets _123')}}</h4>
										</div>
