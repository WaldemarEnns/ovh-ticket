						...
						<form method="POST" enctype="multipart/form-data" id="assigned_form" name="assigned_form">
							...
							<div class="modal-body">
								...
								<div class="custom-controls-stacked d-md-flex" >
									<select multiple="multiple" class="form-control multiselect select2-show-search  select2" data-placeholder="{{lang('Select Agent')}}" name="assigned_user_id[]" id="username" >
