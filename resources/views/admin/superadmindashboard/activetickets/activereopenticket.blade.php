		...
		@endsection
							...
							<div class="page-header d-xl-flex d-block">
								<div class="page-leftheader">
									<h4 class="page-title"><span class="font-weight-normal text-muted ms-2">{{lang('Total Active Re-Open Tickets', 'menu')}}</span></h4>
								</div>
							</div>
							<!--End Page header-->
							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card ">
									<div class="card-header border-0">
										<h4 class="card-title">{{lang('Total Active Re-Open Tickets', 'menu')}}</h4>
									</div>
										...
										<div class="  spruko-delete">
											...
											<div class=" ">
												<table
													...
													<tbody id="refresh">
														@php $i = 1; @endphp
														@foreach ($allactivereopentickets as $tickets)
