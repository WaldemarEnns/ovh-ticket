	...
	<div class="col-xl-12 col-md-12 col-lg-12">
		<div class="row">
			<div class="col-xl-9 col-lg-12 col-md-12">
				...
				@if($ticket->ticketassignmutliples->isNotEmpty() && $ticket->selfassignuser_id == null)
					...
					@else
						<div class="alert alert-light-danger br-13 ">
							<div class="">
							@if(Auth::user()->getRoleNames()[0] != 'Modérateur'  || Auth::user()->getRoleNames()[0] != 'Moderator'  || Auth::user()->getRoleNames()[0] != 'moderator')
				...
				@if($ticket->ticketassignmutliples->isNotEmpty() && $ticket->selfassignuser_id == null)
					@if(!empty(Auth::user()->getRoleNames()[0]) && (Auth::user()->getRoleNames()[0] == 'superadmin' || Auth::user()->getRoleNames()[0] == 'Modérateur'))
