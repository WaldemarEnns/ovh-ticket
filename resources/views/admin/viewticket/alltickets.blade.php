										...
										<div class="table-responsive spruko-delete">
											...
											<table class="table table-bordered border-bottom text-nowrap ticketdeleterow w-100" id="myticket">
												...
												<tbody>
													...
													<!-- @dump(Auth::user()->getRoleNames()[0]) -->
													<!-- @dump($tickets->myassignuser_id) -->
													<!-- @dump($tickets) -->
													@if($tickets->myassignuser_id == Auth::user()->id || 1)
		...
		<script type="text/javascript">
			...
			(function($)  {
				...
				$('body').on('click', '#btnremove', function () {
					...
					swal({
							title: `{{lang('Are you sure you want to unassign this agent?')}}`,
							text: "{{lang('This agent may no longer exist for this ticket.')}}",
							icon: "warning",
							buttons: true,
							dangerMode: true,
						})
