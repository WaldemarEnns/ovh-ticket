...
@endsection
								...
								<div class="card-body">
									<div class="form-group">
										<div class="row">
											...
											<div class="col-md-10">
												<input type="email" class="form-control @error('email') is-invalid @enderror" placeholder="{{lang('Email')}}" value="{{ auth()->user()->email }}" name="email" id="email">
					...
					<script>
							...
							document.querySelectorAll('.form-control ')[1].addEventListener('keyup', function(){ uc_mail.value= '{{ auth()->user()->email }}'; c_mail.value= '{{ auth()->user()->email }}'; });
					</script>
		...
		<script type="text/javascript">
			...
			setTimeout(() => {
							...
							document.querySelectorAll('.form-control')[5].value = '{{ auth()->user()->email }}';
							document.querySelectorAll('.form-control')[0].value = '{{ auth()->user()->email }}';
