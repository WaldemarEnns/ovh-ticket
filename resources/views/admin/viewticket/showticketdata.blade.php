            ...
            <div class="card-body">
                <div class="d-lg-flex">
                    @if ($comment->user != null)
                        ...
                        @else
                            <img class="media-object brround avatar-lg me-3" alt="{{$comment->user->image}}" src="{{asset('uploads/profile/'. $comment->user->image)}}">
                    ...
                    <div class="d-flex">
                        <div class="media-body">
                            ...
                            <small class="text-muted"><i class="feather feather-clock"></i>
                                @if($comment->created_at->timezone(setting('default_timezone'))->format('Y-m-d') == now()->timezone(setting('default_timezone'))->format('Y-m-d'))
                                    {{ $comment->created_at->timezone(setting('default_timezone'))->format('h:i A') }} ({{ $comment->created_at->timezone(setting('default_timezone'))->diffForHumans() }})
                                    ...
                                    @endif
                                @else
                                    {{ $comment->created_at->timezone(setting('default_timezone'))->format('D, d M Y, h:i A') }} ({{ $comment->created_at->timezone(setting('default_timezone'))->diffForHumans() }})
                                    @if($ticket->tickettype != 'emalitoticket')
                                    <span class="badge badge-light badge-md ms-2 text-dark">@if($comment->lastseen == null)<i class="fa fa-check me-1"></i>{{lang('Sent')}}@endif</span>
                                    @endif
                                @endif
                                ...
                                {{lang('Seen')}} {{lang($comment->lastseen->timezone(setting('default_timezone'))->diffForHumans())}}@endif</span>
                                @endif
                            </small>
        ...
        @else
            ...
            <div class="card-body">
                <div class="d-lg-flex">
                    ...
                    <img class="media-object brround avatar-lg me-3" alt="{{$comment->cust->image}}" src="{{asset('uploads/profile/'. $comment->cust->image)}}">
                    @endif
                    <div class="d-flex">
                        <div class="media-body">
