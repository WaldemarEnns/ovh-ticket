                        ...
                        <form method="POST" action="{{url('admin/ticket/'. $ticket->ticket_id)}}" enctype="multipart/form-data">
                            ...
                            <div class="card-body status">
                                ...
                                <div class="form-group">
                                    ...
                                    @if(!empty(Auth::user()->getRoleNames()[0]) && (Auth::user()->getRoleNames()[0] == 'IT' || Auth::user()->getRoleNames()[0] == 'Direction' || Auth::user()->getRoleNames()[0] == 'DIRECTION' || Auth::user()->getRoleNames()[0] == 'superadmin' || Auth::user()->getRoleNames()[0] == 'it' || Auth::user()->getRoleNames()[0] == 'Modérateur'  || Auth::user()->getRoleNames()[0] == 'Moderator'  || Auth::user()->getRoleNames()[0] == 'moderator'))
                                        <label class="custom-control form-radio success me-4">
