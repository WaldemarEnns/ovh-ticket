                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="form-group">
                            <div class="switch_section">
                                <div class="switch-toggle d-flex mt-4">
                                    <a class="onoffswitch2">
                                    <input type="checkbox" id="emp_google_two_fact" name="Employe_google_two_fact" value="on"  class=" toggle-class onoffswitch2-checkbox"  @if(setting('Employe_google_two_fact') == 'on') checked="" @endif>
                                    <label for="emp_google_two_fact" class="toggle-class onoffswitch2-label" ></label>
                                    </a>
                                    <div class="ps-3">
                                        <label class="form-label">{{lang('Enable Employee Google Two Factor Authentication', 'setting')}}<small  class="text-muted "> <i>({{lang('If you enable this setting, the application "employees" will be able to use "Google Two Factor Authentication" for login into our appliation.', 'setting')}})</i></small></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="switch_section">
                                <div class="switch-toggle d-flex mt-4">
                                    <a class="onoffswitch2">
                                    <input type="checkbox" id="emp_email_two_fact" name="Employe_email_two_fact" value="on"  class=" toggle-class onoffswitch2-checkbox"  @if(setting('Employe_email_two_fact') == 'on') checked="" @endif>
                                    <label for="emp_email_two_fact" class="toggle-class onoffswitch2-label" ></label>
                                    </a>
                                    <div class="ps-3">
                                        <label class="form-label">{{lang('Enable Employee Email Two Factor Authentication', 'setting')}}<small  class="text-muted "> <i>({{lang('If you enable this setting, the application "employees" will be able to use "Email Two Factor Authentication" for login into our appliation.', 'setting')}})</i></small></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="switch_section">
                                <div class="switch-toggle d-flex mt-4">
                                    <a class="onoffswitch2">
                                    <input type="checkbox" id="cust_google_two_fact" name="Customer_google_two_fact" value="on"  class=" toggle-class onoffswitch2-checkbox"  @if(setting('Customer_google_two_fact') == 'on') checked="" @endif>
                                    <label for="cust_google_two_fact" class="toggle-class onoffswitch2-label" ></label>
                                    </a>
                                    <div class="ps-3">
                                        <label class="form-label">{{lang('Enable Customer Google Two Factor Authentication', 'setting')}}<small class="text-muted "> <i>({{lang('If you enable this setting, the application "customers" will be able to use "Google Two Factor Authentication" for login into our appliation.', 'setting')}})</i></small></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="switch_section">
                                <div class="switch-toggle d-flex mt-4">
                                    <a class="onoffswitch2">
                                    <input type="checkbox" id="cust_email_two_fact" name="Customer_email_two_fact" value="on"  class=" toggle-class onoffswitch2-checkbox"  @if(setting('Customer_email_two_fact') == 'on') checked="" @endif>
                                    <label for="cust_email_two_fact" class="toggle-class onoffswitch2-label" ></label>
                                    </a>
                                    <div class="ps-3">
                                        <label class="form-label">{{lang('Enable Customer Email Two Factor Authentication', 'setting')}}<small class="text-muted"> <i>({{lang('If you enable this setting, the application "customers" will be able to use "Email Two Factor Authentication" for login into our appliation.', 'setting')}})</i></small></label>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="card ">
        ...
        <div class="card-body">
            ...
            <div class="switch_section">
                <div class="switch-toggle d-flex d-md-max-block mt-4">
                    <a class="onoffswitch2">
                        <input type="checkbox"  name="IMAP_STATUS" id="IMAP_STATUS" class=" toggle-class onoffswitch2-checkbox sprukoregister" value="off" @if(setting('IMAP_STATUS') == 'on') checked="" @endif>
                        <label for="IMAP_STATUS" class="toggle-class onoffswitch2-label" ></label>
                    </a>
                    <label class="form-label ps-3 ps-md-max-0">{{lang('Enable Email to ticket', 'setting')}}</label>
                    <small class="text-muted ps-2 ps-md-max-0"><i>({{lang('Configure IMAP settings first on the "Email to Ticket" page and enable this "Email to Ticket" feature so that customers will be able to generate support tickets through their email correspondence.', 'setting')}})</i></small>
                </div>
            </div>
            ...
            <div class="switch_section">
                <div class="switch-toggle d-flex d-md-max-block mt-4">
                    ...
                    <small class="text-muted ps-2 ps-md-max-0"><i>({{lang('If you enable this setting, Customers cannot login to their accounts.', 'setting')}})</i></small>
                </div>
            </div>
            ...
            <div class="switch_section">
                <div class="switch-toggle d-flex d-md-max-block mt-4">
                    ...
                    <small class="text-muted ps-2 ps-md-max-0"><i>({{lang('If you "Enable" this setting, customers can "Delete" their account permanently.', 'setting')}})</i></small>
                </div>
            </div>
