...
@extends('layouts.usermaster')
        ...
        @if(setting('ANNOUNCEMENT_USER') == 'only_login_user' || setting('ANNOUNCEMENT_USER') == 'all_users')
            <div class="uhelp-announcement-alertgroup">
                ...
                {{-- holidays display as announcement --}}

                @foreach ($holidays as $anct)
                    @if ($anct->status == 1)
                        <div class="alert" role="alert" style="background: linear-gradient(to right,{{$anct->primaray_color}}, {{$anct->secondary_color}});">
                            <div class="container">
                                <button type="submit" class="btn-close ms-5 float-end text-white notifyclose" data-id="{{$anct->id}}">×</button>
                                <div class="d-flex align-items-top">
                                    <div class="uhelp-announcement me-2">
                                    ...
                                    <div class="notice-heading d-flex align-items-top flex-fill">
                                        <div>
                                            <span class="fs-15 font-weight-bold text-white flex-fill">{{$anct->occasion}}</span>
                                            <span class="text-white opacity-50 mx-2"><i class="ti ti-minus"></i></span>
                                            <span class="mb-0 text-white uhelp-alert-content alert-notice">{!!$anct->holidaydescription!!}
                                                @if($anct->buttonon == 1)
                                                <a class="btn btn-sm ms-2 text-white text-decoration-underline" href="{{$anct->buttonurl}}" target="_blank">{{$anct->buttonname}}</a>
                                                @endif
                                            </span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="is-loading">
                                                        <input type="email" class="form-control" placeholder="{{lang('Email')}}" name="email" value="" id="email" required>
                                                    ...
                                                    <button type="submit" class="btn btn-sm btn-secondary mt-2" id="sprukoverifybtn" >{{lang('Get OTP')}}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form  method="post" id="guest_form" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-5" id="verifyottp" style="display: none">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <label class="form-label mb-0 mt-2">{{lang('Verify OTP')}}</label>
                                                </div>
                                                <div class="col-md-9">
                                                    <input type="otp number" class="form-control" placeholder="{{lang('Enter Otp')}}" name="verifyotp" value="" id="verifyotp">
                                        ...
                                        <div  class="verifyotp">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="subject" maxlength="{{setting('TICKET_CHARACTER')}}" class="form-control" placeholder="{{lang('Subject')}}" name="subject" value="{{ old('subject') }}" >
                                                        <small class="text-muted float-end mt-1 subjectmaxtext" id="subjectmaxtext">{{lang('Maximum')}}<b>{{setting('TICKET_CHARACTER')}}</b>{{lang('Characters')}}</small>
                                                        <div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select  class="form-control select2-show-search  select2"  data-placeholder="{{lang('Select Category')}}" name="category" id="category">
					...
					$('#sprukoverifybtn').hide();
						...
						$.ajax({
							...
							success: (data) => {
                                ...
                                if(data?.message == 'ticcreaterestrict'){
								...
								if(data.message == 'createverifyotp')
								{
									...
									$('#alertemailerror').html('{{lang('An OTP (One Time Password) has been sent to your email ID. Please enter the OTP below to submit your guest ticket.')}}')
									$('#verifyottp').show();
