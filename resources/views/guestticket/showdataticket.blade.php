            ...
            <div class="card-body" >
                <div class="d-sm-flex">
                    ...
                    <div class="media-body">
                        <h5 class="mt-1 mb-1 font-weight-semibold">{{ $comment->cust->username }} <span class="badge badge-danger-light badge-md ms-2">{{ lang($comment->cust->userType) }}</span></h5>
                        ...
                        <div class="editsupportnote-icon animated" id="supportnote-icon-{{$comment->id}}">
                            <form action="{{url('/guestticket/editcomment/'.$comment->id)}}" method="POST">
                                @csrf
                                @honeypot
                        ...
                        @if ($comment->cust_id != null)
                        <div class="row galleryopen mt-4">
                            <div class="uhelp-attach-container mt-3 flex-wrap">
                        ...
                        <div class="row galleryopen mt-4">
                            ...
                            <div class="file-image-1  removespruko{{$commentss->id}}" id="imageremove{{$commentss->id}}">
                                <div class="product-image  ">
                                    <a href="{{route('guest.imageurl', array($commentss->id,$commentss->file_name))}}" class="imageopen">
                                        <img src="{{route('guest.imageurl', array($commentss->id,$commentss->file_name))}}" class="br-5" alt="{{$commentss->file_name}}">
                                    </a>
                                </div>
                            </div>
                            @endforeach
    ...
    @else
        <div class="card-body" >
            <div class="d-sm-flex">
                ...
                <div class="media-body">
                    @if(setting('customer_panel_employee_protect') == 'on')
                    <h5 class="mt-1 mb-1 font-weight-semibold">{{setting('employeeprotectname')}}</h5>
                    @else
                    @if($comment->user != null)

                    <h5 class="mt-1 mb-1 font-weight-semibold">{{ $comment->user->name }}  @if(!empty($comment->user->getRoleNames()[0]))<span class="badge badge-primary-light badge-md ms-2">{{ lang($comment->user->getRoleNames()[0]) }}</span>@endif</h5>
                    @else
