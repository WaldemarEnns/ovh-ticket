        ...
        <div class="card-body">
            <div class="d-lg-flex">
                ...
                <img src="{{asset('uploads/profile/user-profile.png')}}"
                    class="media-object brround avatar-lg me-3" alt="default">
                @else

                <img class="media-object brround avatar-lg me-3" alt="{{$comment->cust->image}}"
                            ...
                            <form action="{{route('client.comment.edit',$comment->id)}}" method="POST">
                                ...
                                <div class="btn-list mt-1">
                                    <input type="submit" class="btn btn-secondary"
                                        onclick="this.disabled=true;this.form.submit();" value="{{lang('Update')}}">
                                </div>
                            </form>
                        </div>
                    ...
                    @else
                        @if($comment->user != null)
                            ...
                            @else
                                ...
                                <img class="media-object brround avatar-lg me-3" alt="{{$comment->user->image}}"
