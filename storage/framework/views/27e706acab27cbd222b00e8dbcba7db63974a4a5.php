											...
											<div class="col-xl-3">
														...
														<div class="profile-pic">
															<div class="profile-pic-img">
																<span class="bg-success dots" data-bs-toggle="tooltip" data-placement="top" title=""
																	data-bs-original-title="<?php echo e(lang('Online')); ?>"></span>
																...
																<img src="<?php echo e(asset('uploads/profile/'.Auth::guard('customer')->user()->image)); ?>" class="brround avatar-xxl"
												...
												<!-- Bussiness Hour -->
												<?php if(setting('businesshoursswitch') == 'on'): ?>
                                                    <div class="card p-3 pricing-card border d-flex notify-days-toggle">
                                                        <div class="d-md-flex d-block">
                                                            <div  class="support-img1">
                                                                <?php if(setting('supporticonimage') != null): ?>

                                                                <img src="<?php echo e(asset('uploads/support/'. setting('supporticonimage'))); ?>" class="rounded-circle" alt="img" width="50" height="50">
                                                                <?php else: ?>

                                                                <img src="<?php echo e(asset('assets/images/support/support.png')); ?>" alt="img" width="50" height="50">
                                                                <?php endif; ?>
                                                            ...
                                                            <div class="card-header text-justified flex-1 pt-0 ps-md-3 ps-0 pb-0 ">
                                                                <p class="fs-18 font-weight-semibold mb-1"><?php echo e(setting('businesshourstitle')); ?>

                                                                    <?php if($holidays->isNotEmpty()): ?>
                                                                        <span class="ms-3 badge bg-danger text-white  mt-1 fs-12 font-weight-normal"><?php echo e(lang('offline')); ?></span>
                                                                    <?php else: ?>
                                                                        <?php $__currentLoopData = bussinesshour(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bussiness): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            ...
                                                                            <?php if(now()->timezone(setting('default_timezone'))->format('D') == $bussiness->weeks): ?>
                                                                                ...
                                                                                <?php if(strtotime($bussiness->starttime) <= strtotime(now()->timezone(setting('default_timezone'))->format('h:i A')) && strtotime($bussiness->endtime) >= strtotime(now()->timezone(setting('default_timezone'))->format('h:i A'))|| $bussiness->starttime == "24H"): ?>


                                                                                    <?php if($bussiness->starttime != "24H"): ?>
                                                                                        <span class="ms-3 badge bg-success text-white  mt-1 fs-12 font-weight-normal"><?php echo e(lang('online')); ?></span>
                                                                                    <?php else: ?>
                                                                                        <span class="ms-3 badge bg-success text-white  mt-1 fs-12 font-weight-normal"><?php echo e(lang('online')); ?></span>
                                                                                    <?php endif; ?>
                                                                                <?php else: ?>
                                                                ...
                                                                <p class="fs-13 mb-0 text-muted"><?php echo e(setting('businesshourssubtitle')); ?></p>
                                                            </div>
                                                        ...
                                                        <div class="card-body  pt-0 pb-0 px-4 notify-days-container">
                                                            <ul class="custom-ul text-justify pricing-body text-muted ps-0 mb-4">
                                                                ...
                                                                <?php $__empty_1 = true; $__currentLoopData = $holidays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $holiday): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                    <?php
                                                                        $datetimeall = [];
                                                                        for ($i = (int)$holiday->startdate->format('d'); $i <= (int)$holiday->enddate->format('d'); $i++){
                                                                            ...
                                                                            <div class="row br-5 notify-days-cal align-items-center p-2 br-5 border text-center <?php echo e(now()->timezone(setting('default_timezone'))->format('D') == $bussiness->weeks ? 'bg-success-transparent' : ''); ?>">
                                                                                ...
                                                                                <div class="col-xxl-6 col-xl-5 col-sm-12 px-0">
                                                                                    ...
                                                                                    <?php else: ?>
                                                                                        ...
                                                                                        <?php else: ?>
                                                                                            <?php if($holidays->isNotEmpty() && in_array($bussiness->weeks,$datetimeall)): ?>
                                                                                                <span class="text-danger fs-12 ms-2"><?php echo e(lang('Closed')); ?></span>
                                                                                            <?php else: ?>
                                                                                                <span class="ms-0 fs-13"><?php echo e($bussiness->starttime); ?>
...
<?php /**PATH /home/steursr/www/resources/views/includes/user/verticalmenu.blade.php ENDPATH**/ ?>