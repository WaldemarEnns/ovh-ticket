									...
									<div class="card-header border-0 d-sm-flex d-block">
										...
										<div class="card-options mt-sm-max-2 d-sm-flex d-block">
											...
											<?php if(setting('ENVATO_ON') == 'on'): ?>
												...
												<button class="btn btn-info mb-sm-0 mb-2" id="envatoapiassign"><?php echo e(lang('Envato Api Assign')); ?></button>
											<?php endif; ?>
											<?php endif; ?>
		...
		<script type="text/javascript">
			...
			(function($)  {
				...
				$('#envatoapiassign').on('click', function(){
					...
					$('.modal-title').html("<?php echo e(lang('Assign Envato Api')); ?>");
		...
		<?php echo $__env->make('admin.category.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				...
				<?php echo $__env->make('admin.category.envatocategorylist', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/steursr/www/resources/views/admin/category/index.blade.php ENDPATH**/ ?>