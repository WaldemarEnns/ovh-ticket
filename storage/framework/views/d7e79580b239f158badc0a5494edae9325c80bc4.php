...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if(!empty(Auth::user()->getRoleNames()[0]) && (Auth::user()->getRoleNames()[0] == 'IT' || Auth::user()->getRoleNames()[0] == 'Direction' || Auth::user()->getRoleNames()[0] == 'DIRECTION' || Auth::user()->getRoleNames()[0] == 'superadmin' || Auth::user()->getRoleNames()[0] == 'it' || Auth::user()->getRoleNames()[0] == 'Modérateur'  || Auth::user()->getRoleNames()[0] == 'Moderator'  || Auth::user()->getRoleNames()[0] == 'moderator')): ?>
                                        <label class="custom-control form-radio success me-4">
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/steursr/www/resources/views/admin/viewticket/showticketdata/showticketinclude.blade.php ENDPATH**/ ?>