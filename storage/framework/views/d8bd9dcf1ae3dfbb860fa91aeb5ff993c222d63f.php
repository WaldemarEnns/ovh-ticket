					...
					<tr>
						...
						<td>
							...
							<?php if($ticket->category_id != null): ?>
								...
								<?php else: ?>
									<?php if($ticket->status != 'Closed' && $ticket->status != 'Suspend'): ?>
									<a href="javascript:void(0)" data-id="<?php echo e($ticket->ticket_id); ?>" class="p-1 sprukocategory border border-primary br-7 text-white bg-primary" > <i class="feather feather-plus" data-toggle="tooltip" data-bs-placement="top" title="<?php echo e(lang('Add Category')); ?>"></i></a>
									<?php endif; ?>
								<?php endif; ?>
							<?php else: ?>
								<?php if($ticket->status != 'Closed' && $ticket->status != 'Suspend'): ?>
...
<?php /**PATH /home/steursr/www/resources/views/admin/viewticket/showticketdata/ticketinfooter.blade.php ENDPATH**/ ?>