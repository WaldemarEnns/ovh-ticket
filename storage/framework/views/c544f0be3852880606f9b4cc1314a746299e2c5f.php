                ...
                <div class="d-lg-flex">
                    <?php if($comment->user != null): ?>
                        <?php if($comment->user->image == null): ?>
                            ...
                            <img src="<?php echo e(asset('uploads/profile/user-profile.png')); ?>"  class="media-object brround avatar-lg me-3" alt="default">
                        <?php else: ?>
                            <img class="media-object brround avatar-lg me-3" alt="<?php echo e($comment->user->image); ?>" src="<?php echo e(asset('uploads/profile/'. $comment->user->image)); ?>">
                    ...
                    <div class="d-flex">
                        <div class="media-body">
                            ...
                            <small class="text-muted"><i class="feather feather-clock"></i>
                                <?php if($comment->created_at->timezone(setting('default_timezone'))->format('Y-m-d') == now()->timezone(setting('default_timezone'))->format('Y-m-d')): ?>
                                    <?php echo e($comment->created_at->timezone(setting('default_timezone'))->format('h:i A')); ?> (<?php echo e($comment->created_at->timezone(setting('default_timezone'))->diffForHumans()); ?>)
                                    <?php if($ticket->tickettype != 'emalitoticket'): ?>
                                    <span class="badge badge-light badge-md ms-2 text-dark"><?php if($comment->lastseen == null): ?><i class="fa fa-check me-1"></i><?php echo e(lang('Sent')); ?><?php endif; ?></span>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <?php echo e($comment->created_at->timezone(setting('default_timezone'))->format('D, d M Y, h:i A')); ?> (<?php echo e($comment->created_at->timezone(setting('default_timezone'))->diffForHumans()); ?>)
                                    <?php if($ticket->tickettype != 'emalitoticket'): ?>
                                    <span class="badge badge-light badge-md ms-2 text-dark"><?php if($comment->lastseen == null): ?><i class="fa fa-check me-1"></i><?php echo e(lang('Sent')); ?><?php endif; ?></span>
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if($ticket->tickettype != 'emalitoticket'): ?>
                                <span class="badge badge-success-light badge-md ms-2"><?php if($comment->lastseen != null): ?>
                                ...
                                <?php echo e(lang('Seen')); ?> <?php echo e(lang($comment->lastseen->timezone(setting('default_timezone'))->diffForHumans())); ?><?php endif; ?></span>
                                <?php endif; ?>
                            </small>
                            <div class="fs-13 mb-0 mt-1 text-break">
                            ...
                            <div class="editsupportnote-icon animated" id="supportnote-icon-<?php echo e($comment->id); ?>">
                                ...
                                <div class="btn-list mt-1">
                                    <input type="submit" class="btn btn-secondary deletelocalstorage" onclick="this.disabled=true;this.form.submit();" value="Update">
                                    <button type="button" class="btn btn-default" onclick="showEditForm('<?php echo e($comment->id); ?>')" data-dismiss="modal">Close</button>
                                </div>
                                </form>
                            </div>
                                        ...
                                        <?php $__currentLoopData = $comment->getMedia('comments'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commentss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="border d-table rounded attach-container-width mb-2">
                                                ...
                                                <div class="d-flex mt-2 mt-sm-0">
                                                    <a href="<?php echo e(route('imageurl', array($commentss->id,$commentss->file_name))); ?>" target="_blank" class=" uhelp-attach-acion p-2 rounded border lh-1 me-1 d-flex align-items-center justify-content-center"><i
                                                                        class="fe fe-eye text-muted fs-12"></i></a>
                                                    <a href="<?php echo e(route('imagedownload', array($commentss->id,$commentss->file_name))); ?>" class="uhelp-attach-acion p-2 rounded border lh-1 d-flex align-items-center justify-content-center"><i
                    ...
                    <?php if(Auth::id() == $comment->user_id || Auth::user()->getRoleNames()[0] == 'superadmin'): ?>
                        ...
                        <div class="ms-auto">
                            ...
                            <div class="d-flex">
                                ...
                                <a href="javascript:void(0)" class="action-btns" data-id="<?php echo e($comment->id); ?>" id="deletecomment" data-bs-toggle="tooltip" data-placement="top" title="Delete Comment"><i class="feather feather-trash-2 text-danger fs-16"></i></a>
                            </div>
                        </div>
                    ...
                    <?php if($ticket->status == 'Closed'): ?>
                        <div class="ms-auto">
                            <input type="checkbox" name="spruko_checkbox[]" class="tickettoarticle" value="<?php echo e($comment->id); ?>" />
                        </div>
                    <?php endif; ?>
        ...
        <?php else: ?>
            ...
            <div class="card-body">
                <div class="d-lg-flex">
                    ...
                    <img class="media-object brround avatar-lg me-3" alt="<?php echo e($comment->cust->image); ?>" src="<?php echo e(asset('uploads/profile/'. $comment->cust->image)); ?>">
                    <?php endif; ?>
                    <div class="d-flex">
                        <div class="media-body">
                            ...
                            <div class="row galleryopen mt-4">
                                <div class="d-flex flex-wrap">
                                    <div class="uhelp-attach-container flex-wrap">
                                        <?php if($comment->emailcommentfile != null): ?>
                                            <?php if($comment->emailcommentfile == 'mismatch'): ?>
                                                ...
                                                <?php $__currentLoopData = $arraytype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arraytypes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="border d-table rounded attach-container-width mb-2">
                                                        <div class="d-flex align-items-center file-attach-uhelp">
                                                            <div class="me-2">
                                                                <!-- <img src="<?php echo e(asset('uploads/emailtoticket/'.$comment->emailcommentfile)); ?>" alt="img" class="header-text3 call-to-action-image img-fluid"> -->
                                                            ...
                                                            <a href="<?php echo e(route('emtcimageurl', array($comment->id,$arraytypes))); ?>" target="_blank" class="uhelp-attach-acion p-2 rounded border lh-1 me-1 d-flex align-items-center justify-content-center"><i
                                                                                class="fe fe-eye text-muted fs-12"></i></a>
                                                            <a href="<?php echo e(route('emtcimagedownload', array($comment->id,$arraytypes))); ?>" class="uhelp-attach-acion p-2 rounded border lh-1 d-flex align-items-center justify-content-center"><i
                                                                    class="fe fe-download text-muted fs-12"></i></a>
                                                        </div>
                                                    </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH /home/steursr/www/resources/views/admin/viewticket/showticketdata.blade.php ENDPATH**/ ?>