		...
		<?php $__env->stopSection(); ?>
										...
										<div class="d-flex breadcrumb-res">
											<div class="header-datepicker me-3">
												<div class="input-group">
                                                    ...
                                                    <!-- <input class="form-control fc-datepicker pb-0 pt-0" value="<?php echo e(\Carbon\Carbon::now(Auth::user()->timezone)->format(setting('date_format'))); ?>" type="text" disabled> -->
												</div>
											</div>
							...
							<div class="row">
								<div class="col-xl-4">
									<h6 class="mb-3 fw-semibold"><?php echo e(lang('General Tickets')); ?></h6>
									<div class="row">
													...
													<a href="<?php echo e(route('admin.recenttickets')); ?>">
                                                        <div class="d-flex">
                                                            <span class="me-3 my-auto">
                                                                <svg class="tickets-recent primary" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 60 60" viewBox="0 0 60 60">
                                                            ...
                                                            <div class="">
                                                                <p class="fs-14 font-weight-semibold mb-0"><?php echo e(lang('Recents Tickets')); ?>

                                                                </p>
                                                                <h3 class="mb-0 text-primary"><?php echo e($recentticketcount); ?></h3>
                                                            </div>
                                                        </div>
                                                    </a>
												</div>
											...
											<div class="card">
												<div class="card-body">
													<a href="<?php echo e(url('/admin/activeticket')); ?>">
                                                        <div class="d-flex">
                                                            <span class="me-3 my-auto">
                                                                <svg class="tickets-recent secondary" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 60 60" viewBox="0 0 60 60">
                                                                    <path d="M54,15H6c-0.5522461,0-1,0.4477539-1,1v10c0,0.5522461,0.4477539,1,1,1c1.6542969,0,3,1.3457031,3,3s-1.3457031,3-3,3
                                                                        c-0.5522461,0-1,0.4477539-1,1v10c0,0.5522461,0.4477539,1,1,1h48c0.5522461,0,1-0.4477539,1-1V34c0-0.5522461-0.4477539-1-1-1
                                                                        c-1.6542969,0-3-1.3457031-3-3s1.3457031-3,3-3c0.5522461,0,1-0.4477539,1-1V16C55,15.4477539,54.5522461,15,54,15z M53,25.1005859
                                                                        C50.7207031,25.5649414,49,27.5854492,49,30s1.7207031,4.4350586,4,4.8994141V43h-9.0371094h-2H7v-8.1005859
                                                            ...
                                                            <div>
                                                                <p class="fs-14 font-weight-semibold mb-0"><?php echo e(lang('Unassigned Tickets')); ?></p>

                                                                    <h3 class="mb-0 text-secondary"><?php echo e($totalactivetickets); ?></h3>
                                                                    <?php if($totalactiverecent > 0): ?>
                                                                        <span class="position-absolute uhelp-reply-badge pulse-badge" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Un-Answered"><i class="fa fa-commenting me-1"></i><?php echo e($totalactiverecent); ?></span>
                                                                    <?php else: ?>
								...
								<div class="col-xl-8">
									<h6 class="fw-esmibold mb-3"><?php echo e(lang('Self Tickets')); ?></h6>
									<div class="row">
														...
														<div class="d-flex align-items-center">
															...
															<div>
																<p class="fs-14 font-weight-semibold mb-1">
                                                                    ...
                                                                    <?php if($selfassignrecentreply > 0): ?>
                                                                        <span class="position-absolute uhelp-reply-badge pulse-badge" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Un-Answered"><i class="fa fa-commenting me-1"></i><?php echo e($selfassignrecentreply); ?></span>
                                                                    <?php else: ?>
                                                                        <span class="position-absolute uhelp-reply-badge pulse-badge disabled" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Un-Answered"><i class="fa fa-commenting me-1"></i>0</span>
                                                                    <?php endif; ?>
														...
														<div class="d-flex align-items-center">
															...
															<div>
																<p class="fs-14 font-weight-semibold mb-1">
                                                                    ...
                                                                    <?php if($myassignedticketrecentreply > 0): ?>
                                                                        <span class="position-absolute uhelp-reply-badge pulse-badge" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Un-Answered"><i class="fa fa-commenting me-1"></i><?php echo e($myassignedticketrecentreply); ?></span>
                                                                    <?php else: ?>
                                                                        <span class="position-absolute uhelp-reply-badge pulse-badge disabled" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Un-Answered"><i class="fa fa-commenting me-1"></i>0</span>
                                                                    <?php endif; ?>
							...
							<!-- <?php if(!empty(Auth::user()->getRoleNames()[0]) && (Auth::user()->getRoleNames()[0] == 'Modérateur' || Auth::user()->getRoleNames()[0] == 'MODERATOR' || Auth::user()->getRoleNames()[0] == 'moderator' || Auth::user()->getRoleNames()[0] == 'superadmin')): ?> -->
							<div class="row row-sm">
								<div class="col-lg-12">
									<div class="card">
										<div class="card-header border-0">
											
											<h4 class="card-title"><?php echo e(lang('Recent Tickets _123')); ?></h4>
										</div>
										<div class="card-body overflow-scroll">
											<div class="">
												...
												<div class="dashboardtabledata" >
													<table class="table table-bordered border-bottom text-nowrap ticketdeleterow" id="supportticket-dashe">
														<thead>
															<tr>
...
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/steursr/www/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>