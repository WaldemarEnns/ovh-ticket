				...
				<div class="modal-content">
					...
					<form method="POST" enctype="multipart/form-data" id="sprukopasswordreset_form" name="sprukopasswordreset_form">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-secondary sprukoempchange" id="sprukoempchange" ><?php echo e(lang('Save')); ?></button>
                        </div>
                    </form>
				</div>
			</div>
        ...
        </script><?php /**PATH /home/steursr/www/resources/views/admin/agent/passwordresetmodal.blade.php ENDPATH**/ ?>