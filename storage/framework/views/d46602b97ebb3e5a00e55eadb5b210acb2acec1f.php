...
unset($__errorArgs, $__bag); ?>"  data-callback="recaptchaCallback" data-sitekey="<?php echo e(setting('GOOGLE_RECAPTCHA_KEY')); ?>"></div>
                            ...
                            <!--- End Google ReCaptcha --->
                                <div class="submit">
                                    <input class="btn btn-secondary btn-block" type="submit" value="Login" onclick="login();this.disabled=true;">
                                </div>
                                <div class="text-center mt-3">
                                <a href="#" id="forgot1" class="text-primary pb-2"><?php echo e(lang('Forgot Password?')); ?></a>
                                    <?php if(setting('REGISTER_DISABLE') == 'on'): ?>
                                    <p class="text-dark mb-0"><?php echo e(lang('Don’t have account?')); ?><a class="text-primary ms-1" href="#"
                                            data-bs-toggle="modal" id="register1"
                                            data-bs-target="#registermodal"><?php echo e(lang('Register', 'menu')); ?></a></p>
                                    <?php endif; ?>
                                </div>
                            </form>
                        </div>
        ...
        $.ajax({
            ...
            success : function(response)
            {
                ...
                else if(response == 4)
                {
                    ...
                    // $("#err").hide().html("Please Verify Your Email").fadeIn('slow');
                }
                else if(response == 5)
                {
...
<?php /**PATH /home/steursr/www/resources/views/user/auth/modalspopup/login.blade.php ENDPATH**/ ?>