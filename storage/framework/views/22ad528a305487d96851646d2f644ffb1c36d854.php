...
<!-- <?php if(!empty(Auth::user()->getRoleNames()[0]) && (Auth::user()->getRoleNames()[0] == 'Modérateur' || Auth::user()->getRoleNames()[0] == 'MODERATOR' || Auth::user()->getRoleNames()[0] == 'moderator' || Auth::user()->getRoleNames()[0] == 'superadmin')): ?> -->
							...
							<div class="page-header d-xl-flex d-block">
								<div class="page-leftheader">
									<h4 class="page-title"><span class="font-weight-normal text-muted ms-2"><?php echo e(lang('Recent Tickets', 'menu')); ?></span></h4>
								</div>
							</div>
							<!--End Page header-->
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card ">
									<div class="card-header border-0">
										<h4 class="card-title"><?php echo e(lang('Recent Tickets', 'menu')); ?></h4>
									</div>
									<div class="card-body overflow-scroll" >
										<div class=" spruko-delete">
											<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Ticket Delete')): ?>

											<button id="massdelete" class="btn btn-outline-light btn-sm mb-4 ticketdeleterow data-table-btn"><i class="fe fe-trash"></i> <?php echo e(lang('Delete')); ?></button>
											<?php endif; ?>
											<div>
												<table class="table table-bordered border-bottom text-nowrap"  id="overduetickets">
													<thead >
														<tr >
													...
													<tbody id="refresh">
														<?php $i = 1; ?>
														<?php $__currentLoopData = $recenttickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tickets): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/steursr/www/resources/views/admin/superadmindashboard/recenttickets.blade.php ENDPATH**/ ?>