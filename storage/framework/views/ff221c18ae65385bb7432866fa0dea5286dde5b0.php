	...
	<div class="col-xl-12 col-md-12 col-lg-12">
		<div class="row">
			<div class="col-xl-9 col-lg-12 col-md-12">
                        ...
                        <?php if(decrypt($ticket->purchasecode) != 'undefined'): ?>
                            ...
                            <div class="purchasecodes alert alert-light-warning br-13 ">
                                <div class="ps-0 pe-0 pb-0">
                                    <div class="">
                                        <strong><?php echo e(lang('Purchase Code')); ?> :</strong>
                                        <?php if(!empty(Auth::user()->getRoleNames()[0]) && Auth::user()->getRoleNames()[0] == 'superadmin'): ?>
				...
				<?php if($ticket->ticketassignmutliples->isNotEmpty() && $ticket->selfassignuser_id == null): ?>
					...
					<?php else: ?>
						<div class="alert alert-light-danger br-13 ">
							<div class="">
							<?php if(Auth::user()->getRoleNames()[0] != 'Modérateur'  || Auth::user()->getRoleNames()[0] != 'Moderator'  || Auth::user()->getRoleNames()[0] != 'moderator'): ?>
				...
				<?php if($ticket->ticketassignmutliples->isNotEmpty() && $ticket->selfassignuser_id == null): ?>
					<?php if(!empty(Auth::user()->getRoleNames()[0]) && (Auth::user()->getRoleNames()[0] == 'superadmin' || Auth::user()->getRoleNames()[0] == 'Modérateur')): ?>
...
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/steursr/www/resources/views/admin/viewticket/showticket.blade.php ENDPATH**/ ?>