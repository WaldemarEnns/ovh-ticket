        ...
        <div class="app-sidebar__user">
            <div class="dropdown user-pro-body text-center">
                <div class="user-pic">
                    ...
                    <img src="<?php echo e(asset('uploads/profile/'.Auth::user()->image)); ?>" class="avatar-xxl rounded-circle mb-1"
        ...
        <ul class="side-menu custom-ul">
           ...
           <li class="slide">
               ...
               <ul class="slide-menu custom-ul">
                   ...
                   <li><a href="<?php echo e(route('admin.suspendedtickets')); ?>" class="slide-item"><?php echo e(lang('Suspended Tickets', 'Menu')); ?></a></li>
           ...
           <li class="slide">
               ...
               <ul class="slide-menu custom-ul">
                   ...
                   <li><a href="<?php echo e(route('admin.mysuspendtickets')); ?>" class="slide-item"><?php echo e(lang('Suspend Tickets', 'Menu')); ?></a></li>
               </ul>
           </li>
           <?php endif; ?>
           ...
           <!--- End Trashed Ticket For Admin -->
            ...
            <li class="slide">
                ...
                <ul class="slide-menu custom-ul">
                    ...
                    <li><a href="<?php echo e(url('/admin/testimonial')); ?>" class="slide-item"><?php echo e(lang('Testmonial', 'Menu')); ?></a>
                    </li>
                    <?php endif; ?>
            ...
            <?php if(Auth::user()->dashboard == 'Admin_blocked'): ?>
                <li class="slide">
...
<!--aside closed-->
<?php /**PATH /home/steursr/www/resources/views/includes/admin/verticalmenu.blade.php ENDPATH**/ ?>