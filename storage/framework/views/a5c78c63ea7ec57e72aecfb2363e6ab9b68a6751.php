		...
		<?php $__env->stopSection(); ?>
							...
							<div class="page-header d-xl-flex d-block">
								<div class="page-leftheader">
									<h4 class="page-title"><span class="font-weight-normal text-muted ms-2"><?php echo e(lang('Total Active Tickets', 'menu')); ?></span></h4>
								</div>
							</div>
							<!--End Page header-->
							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="row">
									<div class="col-12 col-sm-6 col-lg-3">
										<div class="card">
											<a href="<?php echo e(route('admin.activeticket.allactiveinprogresstickets')); ?>" class="admintickets"></a>
											<div class="card-body d-flex align-items-center justify-content-between  p-4 px-5">
												<div>
													<p class="fs-13 mb-1 font-weight-semibold"><?php echo e(lang('In-Progress')); ?></p>
													<h4 class="mb-0"><?php echo e($allactiveinprogresstickets); ?>
														...
														<span class="text-muted fs-11">
															<span class="text-danger fs-11 mt-2 me-1">
																...
																<?php echo e($allactiveoverduetickets); ?>

															</span>
															<?php echo e(lang('Overdue')); ?>
									...
									<div class="col-12 col-sm-6 col-lg-3">
										<div class="card">
											<a href="<?php echo e(route('admin.activeticket.allactivereopentickets')); ?>" class="admintickets"></a>
											<div class="card-body d-flex align-items-center justify-content-between  p-4 px-5">
												<div>
													<p class="fs-13 mb-1 font-weight-semibold"><?php echo e(lang('Re-Open')); ?></p>
													<h4 class="mb-0"><?php echo e($allactivereopentickets); ?></h4>
												</div>
												<div class="ticket-state-svg">
									...
									<div class="col-12 col-sm-6 col-lg-3">
										<div class="card">
											<a href="<?php echo e(route('admin.activeticket.allactiveonholdtickets')); ?>" class="admintickets"></a>
											<div class="card-body d-flex align-items-center justify-content-between  p-4 px-5">
												<div>
													<p class="fs-13 mb-1 font-weight-semibold"><?php echo e(lang('On-Hold')); ?></p>
													<h4 class="mb-0"><?php echo e($allactiveonholdtickets); ?></h4>
												</div>
												<div class="ticket-state-svg">
									...
									<div class="col-12 col-sm-6 col-lg-3">
										<div class="card">
											<a href="<?php echo e(route('admin.activeticket.allactiveassignedtickets')); ?>" class="admintickets"></a>
											<div class="card-body d-flex align-items-center justify-content-between  p-4 px-5">
												<div>
													<p class="fs-13 mb-1 font-weight-semibold"><?php echo e(lang('Assigned')); ?></p>
													<h4 class="mb-0"><?php echo e($allactiveassignedtickets); ?></h4>
												</div>
												<div class="ticket-state-svg">
							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card">
									<div class="card-header border-0">
										<h4 class="card-title"><?php echo e(lang('Total Active Tickets', 'menu')); ?></h4>
									</div>
										...
										<div class="spruko-delete">
											...
											<div>
												<table
													...
													<tbody id="refresh">
														<?php $i = 1; ?>
														<?php $__currentLoopData = $allactivetickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tickets): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																...
																<div class="d-flex align-items-center">
																	<div class="">
																		...
																		<ul class="fs-13 font-weight-normal d-flex custom-ul">
																			...
																			<li class="px-2 text-muted" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(lang('Date')); ?>"><i class="fe fe-calendar me-1 fs-14"></i> <?php echo e($tickets->created_at->timezone(Auth::user()->timezone)->format(setting('date_format'))); ?></li>
...
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/steursr/www/resources/views/admin/superadmindashboard/activeticket.blade.php ENDPATH**/ ?>