<?php $__env->startSection('content'); ?>
                            	...
                            	<div class="pb-0 px-5 pt-0 text-center">
									<h3 class="mb-2"><?php echo e(lang('Forgot Password?')); ?></h3>
									<p class="text-muted fs-13 mb-1"><?php echo e(lang('Enter the email address that is linked to your account.')); ?></p>
								</div>
								<form class="card-body pt-3 pb-0" id="forgot" action="<?php echo e(url('customer/forgotpassword')); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.custommaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/steursr/www/resources/views/user/auth/passwords/forgotpassword.blade.php ENDPATH**/ ?>