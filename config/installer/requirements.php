...
return [
    ...
    */
    ...
    'length' => ['d65ebe307055908e7e2fc684cb39c763'],
    'requirements' => [
        'php' => [
            'openssl',
            'pdo',
    ...
    */
    'environment' => [
        'form' => [
            'rules' => [
                'app_name'              => 'required|string|max:50|regex:/(^([a-zA-Z]+)(\d+)?$)/u',
    ...
    */
    ...
    /*
     ...
     |
     */
    'purchasecodCheckerUrl' => 'https://panel.spruko.com/envatoverify/verifyenvato.php?code=',
];
